...
declare const _default: React.ComponentType<Pick<$RemoveChildren<React.ComponentType<Pick<import("react-native").PressableProps & React.RefAttributes<View> & {
    ...
    ({ date, time, direction, right, amount, balance, description, onPress, theme, style, amountNumberOfLines, descriptionNumberOfLines, amountEllipsizeMode, descriptionEllipsizeMode, descriptionStyle, amountStyle, balanceStyle, dateStyle, timeStyle, ...rest }: Props): JSX.Element;
    displayName: string;
}, {}>;
