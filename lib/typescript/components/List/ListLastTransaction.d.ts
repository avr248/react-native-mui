...
declare const _default: React.ComponentType<Pick<$RemoveChildren<React.ComponentType<Pick<import("react-native").PressableProps & React.RefAttributes<View> & {
    ...
    ({ date, time, direction, right, amount, description, onPress, theme, style, amountNumberOfLines, descriptionNumberOfLines, amountEllipsizeMode, descriptionEllipsizeMode, descriptionStyle, amountStyle, dateStyle, timeStyle, ...rest }: Props): JSX.Element;
    displayName: string;
}, {}>;
