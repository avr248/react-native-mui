...
const ListLastTransaction = _ref => {
  ...
  return /*#__PURE__*/React.createElement(_TouchableRipple.default, _extends({}, rest, {
    ...
    style: balanceStyle
  }, "Balance ", balance)), /*#__PURE__*/React.createElement(_reactNative.View, {
    style: [_index.vis.w20, _index.vis.col, _index.vis.h40p, _index.vis.sb, _index.vis.aeRl]
  }, /*#__PURE__*/React.createElement(_reactNative.Text, {
    style: timeStyle
  }, time), /*#__PURE__*/React.createElement(_reactNative.Text, {
    style: dateStyle
  }, date))), /*#__PURE__*/React.createElement(_reactNative.View, {
    style: [_index.vis.w75, _index.vis.col, _index.vis.feRl, _index.vis.ac, {
      paddingBottom: 10
    }]
  }, /*#__PURE__*/React.createElement(_reactNative.Text, {
