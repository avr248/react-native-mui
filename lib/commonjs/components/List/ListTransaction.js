...
const ListTransaction = _ref => {
  ...
  return /*#__PURE__*/React.createElement(_TouchableRipple.default, {
    ...rest,
    style: [_vis.default.w100, _vis.default.rowRl, _vis.default.fc, _vis.default.ac, _vis.default.mb2],
    onPress: onPress
...
//# sourceMappingURL=ListTransaction.js.mape, _vis.default.fos4, _vis.default.mb1]
  }, amount), /*#__PURE__*/React.createElement(_reactNative.Text, {
    style: descriptionStyle
  }, description))));
};
