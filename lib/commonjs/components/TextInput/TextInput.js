...
const DefaultRenderer = props => /*#__PURE__*/React.createElement(_reactNative.TextInput, {
  ...props
});
/**
...
const TextInput = (0, _forwardRef.forwardRef)((_ref, ref) => {
  ...
  if (mode === 'outlined') {
    return /*#__PURE__*/React.createElement(_TextInputOutlined.default, {
      dense: dense,
      disabled: disabled,
      error: errorProp,
      multiline: multiline,
  ...
  return /*#__PURE__*/React.createElement(_TextInputFlat.default, {
    dense: dense,
    disabled: disabled,
    error: errorProp,
    multiline: multiline,
...
//# sourceMappingURL=TextInput.js.mapyle: contentStyle
  }));
});
// @component ./Adornment/TextInputIcon.tsx
TextInput.Icon = _TextInputIcon.default;
