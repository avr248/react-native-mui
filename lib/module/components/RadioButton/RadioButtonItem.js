...
const RadioButtonItem = _ref => {
  ...
  let radioButton;
  if (mode === 'android') {
    radioButton = /*#__PURE__*/React.createElement(RadioButtonAndroid, {
      ...radioButtonProps
    });
  } else if (mode === 'ios') {
    radioButton = /*#__PURE__*/React.createElement(RadioButtonIOS, {
      ...radioButtonProps
    });
  } else {
    radioButton = /*#__PURE__*/React.createElement(RadioButton, {
      ...radioButtonProps
    });
  }
