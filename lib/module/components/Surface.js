...
const Surface = forwardRef((_ref3, ref) => {
  ...
  if (!theme.isV3) return /*#__PURE__*/React.createElement(MD2Surface, {
    ...props,
    theme: theme,
    style: style,
    ref: ref
  ...
  return /*#__PURE__*/React.createElement(SurfaceIOS, {
    ...props,
    ref: ref,
    elevation: elevation,
...
//# sourceMappingURL=Surface.js.mapyle, isElevated && {
        elevation: getElevationAndroid()
      }]
    }), children);
  }
