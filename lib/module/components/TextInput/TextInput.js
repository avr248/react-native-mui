...
const DefaultRenderer = props => /*#__PURE__*/React.createElement(NativeTextInput, {
  ...props
});
/**
...
const TextInput = forwardRef((_ref, ref) => {
  ...
  if (mode === 'outlined') {
    return /*#__PURE__*/React.createElement(TextInputOutlined, {
      dense: dense,
      disabled: disabled,
      error: errorProp,
      multiline: multiline,
  ...
  return /*#__PURE__*/React.createElement(TextInputFlat, {
    dense: dense,
    disabled: disabled,
    error: errorProp,
    multiline: multiline,
...
//# sourceMappingURL=TextInput.js.mapltiplier: maxFontSizeMultiplier,
    contentStyle: contentStyle
  }));
});
// @component ./Adornment/TextInputIcon.tsx
