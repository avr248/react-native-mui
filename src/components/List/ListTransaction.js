...
const ListTransaction = ({ date, time, direction, right, amount, balance, balanceTitle, description, onPress, theme, style, amountNumberOfLines = 1, descriptionNumberOfLines = 2, amountEllipsizeMode, descriptionEllipsizeMode, descriptionStyle, amountStyle, balanceStyle, dateStyle, timeStyle, ...rest }) => {
    return (React.createElement(TouchableRipple, { ...rest, style: [vis.w100, vis.rowRl, vis.fc, vis.ac, vis.mb2], onPress: onPress },
