 ...
 * ```
 */
const ListImage = ({ style, source, variant = 'image', theme: themeOverrides, }) => {
    ...
    return (React.createElement(Image, { style: getStyles(), source: source, accessibilityIgnoresInvertColors: true, testID: "list-image" }));
};
