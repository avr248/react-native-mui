...
describe('FABActions - labelStyle - containerStyle', () => {
    it('correctly applies label style', () => {
        const { getByText } = render(React.createElement(FAB.Group, { visible: true, open: true, icon: "", onStateChange: () => { }, actions: [
                {
                    label: 'complete',
                    labelStyle: {
                        fontSize: 24,
    ...
    it('correctly applies containerStyle style', () => {
        const { getByA11yHint } = render(React.createElement(FAB.Group, { visible: true, open: true, icon: "", onStateChange: () => { }, actions: [
                {
                    label: 'remove',
...
it('correctly adds label prop', () => {
    const { getByText } = render(React.createElement(FAB.Group, { visible: true, open: true, label: "Label test", icon: "", onStateChange: () => { }, actions: [
            {
                label: 'testing',
                onPress() { },
                icon: '',
...
it('correct renders custom ripple color passed to FAB.Group and its item', () => {
    const { getByTestId } = render(React.createElement(FAB.Group, { visible: true, open: true, label: "Label test", testID: "fab-group", rippleColor: 'orange', icon: "plus", onStateChange: () => { }, actions: [
            {
                label: 'testing',
                onPress() { },
                icon: '',
    ...
    expect(getByTestId('fab-group-container').props.children.props.rippleColor).toBe('orange');
    expect(getByTestId('fab-group-item-container').props.children.props.rippleColor).toBe('yellow');
});
it('animated value changes correctly', () => {
    const value = new Animated.Value(1);
    const { getByTestId } = render(React.createElement(FAB.Group, { visible: true, open: true, label: "Label test", icon: "", onStateChange: () => { }, testID: "my-fab", fabStyle: [{ transform: [{ scale: value }] }], actions: [
            {
                label: 'testing',
                onPress() { },
                icon: '',
...
describe('FAB.Group events', () => {
    it('onPress passes event', () => {
        ...
        const { getByText } = render(React.createElement(FAB.Group, { visible: true, open: false, label: "Stack test", icon: "", onStateChange: jest.fn(), onPress: onPress, actions: [
                {
                    label: 'testing',
                    onPress() { },
                    icon: '',
    ...
    it('onLongPress passes event', () => {
        ...
        const { getByText } = render(React.createElement(FAB.Group, { visible: true, open: false, label: "Stack test", icon: "", onStateChange: jest.fn(), onLongPress: onLongPress, actions: [
                {
                    label: 'testing',
                    onPress() { },
                    icon: '',
...
describe('Toggle Stack visibility', () => {
    it('toggles stack visibility on press', () => {
        ...
        const { getByText } = render(React.createElement(FAB.Group, { visible: true, open: false, label: "Stack test", icon: "", onStateChange: onStateChange, actions: [
                {
                    label: 'testing',
                    onPress() { },
                    icon: '',
    ...
    it('toggles stack visibility on long press with toggleStackOnLongPress prop', () => {
        const onStateChange = jest.fn();
        const { getByText } = render(React.createElement(FAB.Group, { visible: true, open: false, toggleStackOnLongPress: true, label: "Stack test", icon: "", onStateChange: onStateChange, actions: [
                {
                    label: 'testing',
                    onPress() { },
                    icon: '',
    ...
    it('does not trigger onLongPress when stack is opened', () => {
        const onStateChange = jest.fn();
        const onLongPress = jest.fn();
        const { getByText } = render(React.createElement(FAB.Group, { visible: true, open: true, label: "Stack test", icon: "", onStateChange: onStateChange, onLongPress: onLongPress, actions: [
                {
                    label: 'testing',
                    onPress() { },
                    icon: '',
    ...
    it('does trigger onLongPress when stack is opened and enableLongPressWhenStackOpened is true', () => {
        const onStateChange = jest.fn();
        const onLongPress = jest.fn();
        const { getByText } = render(React.createElement(FAB.Group, { visible: true, open: true, enableLongPressWhenStackOpened: true, label: "Stack test", icon: "", onStateChange: onStateChange, onLongPress: onLongPress, actions: [
                {
                    label: 'testing',
                    onPress() { },
                    icon: '',
