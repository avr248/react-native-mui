...
it('renders chip with onPress', () => {
    const tree = render(React.createElement(Chip, { onPress: () => { } }, "Example Chip")).toJSON();
    expect(tree).toMatchSnapshot();
});
it('renders chip with icon', () => {
    const tree = render(React.createElement(Chip, { icon: "information" }, "Example Chip")).toJSON();
    expect(tree).toMatchSnapshot();
});
it('renders chip with close button', () => {
    const tree = render(React.createElement(Chip, { icon: "information", onClose: () => { } }, "Example Chip")).toJSON();
    expect(tree).toMatchSnapshot();
});
it('renders chip with custom close button', () => {
    const tree = render(React.createElement(Chip, { icon: "information", onClose: () => { }, closeIcon: "arrow-down" }, "Example Chip")).toJSON();
    expect(tree).toMatchSnapshot();
});
it('renders outlined disabled chip', () => {
    const tree = render(React.createElement(Chip, { mode: "outlined", disabled: true }, "Example Chip")).toJSON();
    expect(tree).toMatchSnapshot();
});
it('renders selected chip', () => {
    const tree = render(React.createElement(Chip, { selected: true }, "Example Chip")).toJSON();
    expect(tree).toMatchSnapshot();
});
it('renders disabled chip if there is no touch handler passed', () => {
    const { getByTestId } = render(React.createElement(Chip, { testID: "disabled-chip" }, "Disabled chip"));
...
it('renders active chip if only onLongPress handler is passed', () => {
    const { getByTestId } = render(React.createElement(Chip, { onLongPress: () => { }, testID: "active-chip" }, "Active chip"));
...
it('animated value changes correctly', () => {
    ...
    const { getByTestId } = render(React.createElement(Chip, { onPress: () => { }, testID: "chip", style: [{ transform: [{ scale: value }] }] }, "Example Chip"));
