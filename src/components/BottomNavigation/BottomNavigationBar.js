...
const Touchable = ({ route: _0, style, children, borderless, centered, rippleColor, ...rest }) => TouchableRipple.supported ? (React.createElement(TouchableRipple, { ...rest, disabled: rest.disabled || undefined, borderless: borderless, centered: centered, rippleColor: rippleColor, style: style }, children)) : (React.createElement(TouchableWithoutFeedback, { ...rest },
 ...
 * ```
 */
const BottomNavigationBar = ({ navigationState, renderIcon, renderLabel, renderTouchable = (props) => React.createElement(Touchable, { ...props }), getLabelText = ({ route }) => route.title, getBadge = ({ route }) => route.badge, getColor = ({ route }) => route.color, getAccessibilityLabel = ({ route }) => route.accessibilityLabel, getTestID = ({ route }) => route.testID, activeColor, inactiveColor, keyboardHidesNavigationBar = Platform.OS === 'android', style, labeled = true, animationEasing, onTabPress, onTabLongPress, shifting: shiftingProp, safeAreaInsets, labelMaxFontSizeMultiplier = 1, compact: compactProp, testID = 'bottom-navigation-bar', theme: themeOverrides, }) => {
    ...
    const { backgroundColor: customBackground, elevation = 4 } = (StyleSheet.flatten(style) || {});
    ...
    const backgroundColor = isV3
        ...
        : shifting
            ...
            : approxBackgroundColor;
    const isDark = typeof approxBackgroundColor === 'string'
    ...
    return (React.createElement(Surface, { ...(theme.isV3 && { elevation: 0 }), testID: testID, style: [
            ...
            ? keyboardHidesNavigationBar && keyboardVisible
                ? 'none'
                : 'auto'
            : 'none', onLayout: onLayout },
        React.createElement(Animated.View, { style: [styles.barContent, { backgroundColor }], testID: `${testID}-content` },
            React.createElement(View, { style: [
                ...
                ], accessibilityRole: 'tablist', testID: `${testID}-content-wrapper` },
                shifting && !isV3 ? (React.createElement(Animated.View, { pointerEvents: "none", style: [
                        styles.ripple,
                        {
                            // Since we have a single ripple, we have to reposition it so that it appears to expand from active tab.
                            // We need to move it from the top to center of the navigation bar and from the left to the active tab.
                            top: (BAR_HEIGHT - rippleSize) / 2,
                            left: (Math.min(layout.width, maxTabBarWidth) / routes.length) *
                    ...
                    ], testID: `${testID}-content-ripple` })) : null,
                routes.map((route, index) => {
                    ...
                    return renderTouchable({
                        ...
                        children: (React.createElement(View, { pointerEvents: "none", style: isV3 &&
                                (labeled
                            ...
                            React.createElement(Animated.View, { style: [
                                ...
                                isV3 && focused && (React.createElement(Animated.View, { style: [
                                        styles.outline,
                                        {
                                            transform: [
                                                {
                                ...
                                })) : (React.createElement(Icon, { source: route.focusedIcon, color: activeTintColor, size: 24 }))),
                                React.createElement(Animated.View, { style: [
                                        styles.iconWrapper,
                                        isV3 && styles.v3IconWrapper,
                                        {
                                ...
                                })) : (React.createElement(Icon, { source: theme.isV3 && route.unfocusedIcon !== undefined
                                        ? route.unfocusedIcon
                                        : route.focusedIcon, color: inactiveTintColor, size: 24 }))),
                                React.createElement(View, { style: [styles.badgeContainer, badgeStyle] }, typeof badge === 'boolean' ? (React.createElement(Badge, { visible: badge, size: isV3 ? 6 : 8 })) : (React.createElement(Badge, { visible: badge != null, size: 16 }, badge)))),
                            labeled ? (React.createElement(Animated.View, { style: [
                                ...
                                })) : (React.createElement(Text, { maxFontSizeMultiplier: labelMaxFontSizeMultiplier, variant: "labelMedium", style: [
                                        styles.label,
                                        {
                                            color: activeLabelColor,
                                            ...font,
                                ...
                                })) : (React.createElement(Text, { maxFontSizeMultiplier: labelMaxFontSizeMultiplier, variant: "labelMedium", selectable: false, style: [
                                        styles.label,
                                        {
                                            color: inactiveLabelColor,
                                            ...font,
                                        },
                                    ] }, getLabelText({ route }))))))) : (!isV3 && React.createElement(View, { style: styles.labelContainer })))),
                    });
                })))));
};
