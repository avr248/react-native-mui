 ...
 */
const CardCover = ({ index, total, style, theme: themeOverrides, ...rest }) => {
    ...
    return (React.createElement(View, { style: [styles.container, coverStyle, style] },
        React.createElement(Image, { ...rest, style: [styles.image, coverStyle], accessibilityIgnoresInvertColors: true })));
};
