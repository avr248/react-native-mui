...
const getTooltipXPosition = ({ pageX: childrenX, width: childrenWidth }, { width: tooltipWidth }) => {
...
const getTooltipYPosition = ({ pageY: childrenY, height: childrenHeight }, { height: tooltipHeight }) => {
...
export const getTooltipPosition = ({ children, tooltip, measured }, component) => {
    if (!measured)
        return {};
