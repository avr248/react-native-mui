 ...
 * ```
 */
const ProgressBar = ({ color, indeterminate, style, progress = 0, visible = true, theme: themeOverrides, animatedValue, ...rest }) => {
    ...
    const startAnimation = React.useCallback(() => {
         ...
         */
        const externalAnimation = typeof passedAnimatedValue.current !== 'undefined' &&
    ...
    return (React.createElement(View, { onLayout: onLayout, ...rest, accessible: true, accessibilityRole: "progressbar", accessibilityState: { busy: visible }, accessibilityValue: indeterminate ? {} : { min: 0, max: 100, now: progress * 100 }, style: isWeb && styles.webContainer },
        React.createElement(Animated.View, { style: [
                styles.container,
                { backgroundColor: trackTintColor, opacity: fade },
                style,
            ] }, width ? (React.createElement(Animated.View, { style: [
                styles.progressBar,
                {
                    width,
