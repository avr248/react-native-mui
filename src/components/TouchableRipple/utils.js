...
const getUnderlayColor = ({ theme, calculatedRippleColor, underlayColor, }) => {
...
const getRippleColor = ({ theme, rippleColor, }) => {
    if (rippleColor) {
        return rippleColor;
    }
    if (theme.isV3) {
...
export const getTouchableRippleColors = ({ theme, rippleColor, underlayColor, }) => {
