 ...
 * ```
 */
const AnimatedFAB = ({ icon, label, accessibilityLabel = label, accessibilityState, color: customColor, rippleColor: customRippleColor, disabled, onPress, onLongPress, delayLongPress, theme: themeOverrides, style, visible = true, uppercase: uppercaseProp, testID = 'animated-fab', animateFrom = 'right', extended = false, iconMode = 'dynamic', variant = 'primary', ...rest }) => {
    ...
    const { current: visibility } = React.useRef(new Animated.Value(visible ? 1 : 0));
    const { current: animFAB } = React.useRef(new Animated.Value(0));
    ...
    const { backgroundColor: customBackgroundColor, ...restStyle } = (StyleSheet.flatten(style) || {});
    ...
    return (React.createElement(Surface, { ...rest, testID: `${testID}-container`, style: [
            ...
            styles.container,
            restStyle,
        ], ...(isV3 && { elevation: md3Elevation }), theme: theme },
        React.createElement(Animated.View, { style: [
            ...
            React.createElement(View, { style: [StyleSheet.absoluteFill, styles.shadowWrapper] },
            ...
            React.createElement(Animated.View, { pointerEvents: "box-none", style: [styles.innerWrapper, { borderRadius }] },
                React.createElement(Animated.View, { style: [
                        styles.standard,
                        {
                            width: extendedWidth,
                    ...
                    React.createElement(TouchableRipple, { borderless: true, onPress: onPress, onLongPress: onLongPress, delayLongPress: delayLongPress, rippleColor: rippleColor, disabled: disabled, accessibilityLabel: accessibilityLabel, accessibilityRole: "button", accessibilityState: newAccessibilityState, testID: testID, style: { borderRadius }, theme: theme },
        ...
        React.createElement(Animated.View, { style: [styles.iconWrapper, combinedStyles.iconWrapper], pointerEvents: "none" },
            React.createElement(Icon, { source: icon, size: 24, color: foregroundColor, theme: theme })),
        React.createElement(View, { pointerEvents: "none" },
            React.createElement(AnimatedText, { variant: "labelLarge", numberOfLines: 1, onTextLayout: isIOS ? onTextLayout : undefined, ellipsizeMode: 'tail', style: [
                    {
                    ...
                    textStyle,
                ], theme: theme, testID: `${testID}-text` }, label)),
        !isIOS && (
        ...
        React.createElement(ScrollView, { style: styles.textPlaceholderContainer },
            React.createElement(AnimatedText, { variant: "labelLarge", numberOfLines: 1, onTextLayout: onTextLayout, ellipsizeMode: 'tail', style: [
                    styles.label,
                    uppercase && styles.uppercaseLabel,
                    textStyle,
                ], theme: theme }, label)))));
