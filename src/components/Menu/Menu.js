...
class Menu extends React.Component {
    ...
    keyboardHeight = 0;
    isCoordinate = (anchor) => !React.isValidElement(anchor) &&
    ...
    render() {
        const { visible, anchor, anchorPosition, contentStyle, style, children, theme, statusBarHeight, onDismiss, overlayAccessibilityLabel, keyboardShouldPersistTaps, testID, } = this.props;
        ...
        return (React.createElement(View, { ref: (ref) => {
            ...
            rendered ? (React.createElement(Portal, null,
                React.createElement(TouchableWithoutFeedback, { accessibilityLabel: overlayAccessibilityLabel, accessibilityRole: "button", onPress: onDismiss },
                    React.createElement(View, { style: StyleSheet.absoluteFill })),
                React.createElement(View, { ref: (ref) => {
                        this.menu = ref;
                    }, collapsable: false, accessibilityViewIsModal: visible, style: [styles.wrapper, positionStyle, style], pointerEvents: pointerEvents, onAccessibilityEscape: onDismiss, testID: `${testID}-view` },
                    React.createElement(Animated.View, { pointerEvents: pointerEvents, style: {
                            transform: positionTransforms,
                        } },
                        React.createElement(Surface, { pointerEvents: pointerEvents, style: [
                                ...
                                contentStyle,
                            ], ...(theme.isV3 && { elevation: 2 }), testID: `${testID}-surface`, theme: theme }, (scrollableMenuHeight && (React.createElement(ScrollView, { keyboardShouldPersistTaps: keyboardShouldPersistTaps }, children))) || React.createElement(React.Fragment, null, children)))))) : null));
    }
}
