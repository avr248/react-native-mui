...
const getTitleColor = ({ theme, disabled }) => {
    if (disabled) {
...
const getRippleColor = ({ theme, customRippleColor, }) => {
...
export const getMenuItemColor = ({ theme, disabled, customRippleColor, }) => {
    return {
...
export const getContentMaxWidth = ({ isV3, iconWidth, leadingIcon, trailingIcon, }) => {
    if (isV3) {
