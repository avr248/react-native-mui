...
const getBackgroundColor = ({ theme, isMode, disabled, selected, customContainerColor, }) => {
    if (theme.isV3) {
        if (disabled) {
...
const getIconColor = ({ theme, isMode, disabled, selected, customIconColor, }) => {
    if (theme.isV3) {
        if (disabled) {
...
const getRippleColor = ({ theme, iconColor, customRippleColor, }) => {
...
export const getIconButtonColor = ({ theme, disabled, mode, selected, customIconColor, customContainerColor, customRippleColor, }) => {
