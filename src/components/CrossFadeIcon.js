...
const CrossFadeIcon = ({ color, size, source, theme: themeOverrides, testID = 'cross-fade-icon', }) => {
    ...
    return (React.createElement(View, { style: [
        ...
        previousIcon ? (React.createElement(Animated.View, { style: [
            ...
            React.createElement(Icon, { source: previousIcon, size: size, color: color, theme: theme }))) : null,
        React.createElement(Animated.View, { style: [
            ...
            React.createElement(Icon, { source: currentIcon, size: size, color: color, theme: theme }))));
};
