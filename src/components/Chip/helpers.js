...
const getBorderColor = ({ theme, isOutlined, disabled, selectedColor, backgroundColor, }) => {
...
const getTextColor = ({ theme, isOutlined, disabled, selectedColor, }) => {
    const isSelectedColor = selectedColor !== undefined;
    if (theme.isV3) {
        if (disabled) {
...
const getDefaultBackgroundColor = ({ theme, isOutlined, }) => {
    if (theme.isV3) {
        if (isOutlined) {
...
const getBackgroundColor = ({ theme, isOutlined, disabled, customBackgroundColor, }) => {
...
const getSelectedBackgroundColor = ({ theme, isOutlined, disabled, customBackgroundColor, showSelectedOverlay, }) => {
...
const getIconColor = ({ theme, isOutlined, disabled, selectedColor, }) => {
    const isSelectedColor = selectedColor !== undefined;
    if (theme.isV3) {
        if (disabled) {
            return theme.colors.onSurfaceDisabled;
...
const getRippleColor = ({ theme, isOutlined, disabled, selectedColor, selectedBackgroundColor, customRippleColor, }) => {
...
export const getChipColors = ({ isOutlined, theme, selectedColor, showSelectedOverlay, customBackgroundColor, disabled, customRippleColor, }) => {
