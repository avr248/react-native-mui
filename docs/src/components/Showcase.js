...
const data = [
    {
        ...
        android: 'https://play.google.com/store/apps/details?id=com.callstack.reactnativepaperexample',
    ...
    },
    {
        ...
        android: 'https://play.google.com/store/apps/details?id=com.helsedesign.appngo',
    ...
    },
    {
        ...
        android: 'https://play.google.com/store/apps/details?id=com.mattkoboski.couponsapp',
    ...
    },
    {
        ...
        android: 'https://play.google.com/store/apps/details?id=in.micy.racecalendar',
    ...
    },
    {
        ...
        android: 'https://play.google.com/store/apps/details?id=com.lyra.lyracollect',
    ...
    },
    {
        ...
        android: 'https://play.google.com/store/apps/details?id=com.frederictech.zoomapto',
    },
    {
        color: '#1DE9B6',
        ...
        android: 'https://play.google.com/store/apps/details?id=com.gabrieldierks.groovy',
    },
    {
        color: '#673AB7',
        ...
        android: 'https://play.google.com/store/apps/details?id=com.vibemap.hotspots',
    },
    {
        color: '#6200EE',
    ...
    },
    {
        ...
        android: 'https://play.google.com/store/apps/details?id=com.kylehoell.homeworkhelper',
    },
    {
        color: '#E1352F',
        name: 'CrazyThursday',
...
const getOpacity = (item) => (item ? 1 : 0.4);
export default function Showcase() {
    return (React.createElement("div", { className: "showcase-gallery" }, data.map((item) => {
        const tintColor = color(item.color).isLight() ? '#000000' : '#FFFFFF';
        return (React.createElement("div", { key: item.image },
            React.createElement("div", { className: "showcase-image-container" },
                React.createElement("img", { className: "showcase-image", src: item.image, alt: "" }),
                React.createElement("div", { className: "showcase-info", style: { backgroundColor: item.color } },
                    React.createElement("h3", { className: "showcase-app-name", style: {
                            color: tintColor,
                        } }, item.name),
                    React.createElement("div", { className: "showcase-badge-container" },
                        React.createElement("a", { href: item.android, target: "_blank", rel: "noopener noreferrer", style: { opacity: getOpacity(item.android) } },
                            React.createElement(GooglePlayIcon, { color: tintColor })),
                        React.createElement("div", { className: "showcase-separation" }),
                        React.createElement("a", { href: item.ios, target: "_blank", rel: "noopener noreferrer", style: { opacity: getOpacity(item.ios) } },
                            React.createElement(AppStoreIcon, { color: tintColor })),
                        React.createElement("div", { className: "showcase-separation" }),
                        React.createElement("a", { href: item.github, target: "_blank", rel: "noopener noreferrer", style: { opacity: getOpacity(item.github) } },
                            React.createElement(GithubIcon, { color: tintColor })))))));
    })));
}
